...
return {uu.tx("zbirenbaum/copilot.lua", {cmd = "Copilot", event = "BufEnter", config = _1_}), uu.tx("CopilotC-Nvim/CopilotChat.nvim", {branch = "main", event = "BufEnter", dependencies = {"zbirenbaum/copilot.lua"}, opts = {context = "buffers", debug = false}, keys = {{"<leader>c", "<cmd>CopilotChat<cr>", desc = "Open Copilot Chat"}, {"<leader>c", _2_, desc = "Pick Copilot Action", mode = "v"}}})}
